# Generated by Django 2.0.7 on 2018-08-19 07:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', models.CharField(max_length=128, verbose_name='关键词')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Note', verbose_name='文献')),
            ],
            options={
                'verbose_name': '文献_中介',
                'verbose_name_plural': '文献_中介',
                'ordering': ['-upload_date'],
                'get_latest_by': 'upload_date',
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.ManyToManyField(to='mainapp.Note_middle', verbose_name='文献')),
            ],
            options={
                'verbose_name': '群组',
        ...
        migrations.AddField(
            model_name='note_middle',
            name='sorts',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.Sort', verbose_name='分组'),
        ),
        migrations.AddField(
            model_name='note',
            name='source',
